...
if(isset($_POST["submit"])){
  ...
  $upload_dir = "upimageshin/"; //this is where the uploaded photo stored
  ...
  $upload_dir1 = "upaudiohin/"; //this is where the uploaded photo stored
  ...
  ////////////////////////////////
  $upload_dir2 = "upvideohin/"; //this is where the uploaded photo stored
  ...
  if($upload_ok == 0 && $upload_ok1 == 0 && $upload_ok2 == 0 ){
    echo '<script>alert("sorry your file is not uploaded. Please try again")</script>';
      ...
      if($buttonname != "" && $description !=""){
          ...
          $sql = "INSERT INTO admin_hindi(button_name,description1,image1,audio,video)
...
<head>
    ...
    <title>upload in hindi page</title>
    <link rel="stylesheet" href="upload.css">
</head>
<body>
    <?php
         include_once 'hin_user.php';

    ?>
    <section id="upload_container">
        <form action="ad_hindi.php" method="POST" enctype="multipart/form-data" >
